...
public class OrderRepositoryTests {
	...
	public void testCreateNewOrderWithSingleProduct() {
		...
		mainOrder.setPaymentMethod("CREDIT_CARD");
	...
	public void testUpdateOrder() {
		...
		assertThat(updatedOrder.getStatus()).isEqualTo("SHIPPING");
	}
	...
	public void testFindByOrderTimeBetween() throws ParseException {
		...
		Date startTime = dateFormatter.parse("2023-08-01");
		Date endTime = dateFormatter.parse("2023-08-31");
		...
		for (Order order : listOrders) {
			System.out.printf("%s | %s | %.2f | %.2f \n", 
					order.getId(), order.getOrderTime(), order.getProductCost(), order.getTotal());
		}
	}
}